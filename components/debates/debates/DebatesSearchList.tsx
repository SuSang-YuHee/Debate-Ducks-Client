...
import { useGetDebatesSearch } from "../../../utils/queries/debates";
...
export default function DebatesSearchList({
  list,
  searchValue,
}: {
  list: string[];
  ...
  const debates = useGetDebatesSearch(searchValue, orderSelect.value);

  console.log(debates, searchValue);
