...
export default function QnAPage() {
  ...
  const CONTENTS = [
    ...
    {
      title: "토론 시작 전에 준비할 것이 있나요?",
      detail:
        "카메라, 마이크 및 화면 기록 권한을 허용해 주셔야 합니다. 이전에 따로 설정하지 않으셨다면 해당 기능을 사용할 때 허용 요청이 갈 것입니다. 만약 이전에 권한을 차단하셨다면 해당 브라우저의 설정에서 허용으로 변경해 주셔야 합니다. 추가로 전체 화면 공유와 창 화면 공유의 경우에는 해당 컴퓨터의 설정에서 허용으로 변경해 주셔야 합니다. 토론을 시작하기 전에 확인해 주시길 바랍니다.",
    },
    {
